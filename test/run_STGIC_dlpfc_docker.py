...
for pid in pid_list:
    ...
    print(pid,'\n\n')
print('mean and median ARI of STGIC clustering:',np.array(ari_list).mean(),np.median(np.array(ari_list)))

print('mean and median ARI of STGIC pre-clustering:'np.array(pre_ari_list).mean(),np.median(np.array(pre_ari_list)))